...
bus and session differ in where the identifier comes from, not in what makes
it live, so the rule is written once. thread is the space that does not use
this -- which is the entire reason the axis exists.
"""
